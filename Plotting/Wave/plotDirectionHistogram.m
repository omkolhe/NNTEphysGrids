...
if fit == 0
    ...
    [~, fittedVm] = getClusterDirectionality2(dirComb,0.95,3,nBins);
    nComponents = fittedVm.nComponents;
    likelihoods = fittedVm.pdf(angles);
end
polarhistogram(dirComb,nBins,'Normalization','pdf','FaceColor',[0.4660 0.6740 0.1880],'FaceAlpha',0.3,'EdgeAlpha',0.3);hold on;

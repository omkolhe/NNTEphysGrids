...
% Output file
Intan.amplifier_data = amplifier_data;
Intan.t_amplifier = t_amplifier;
Intan.path = path;
Intan.filename = filename;
Intan.frequency_parameters = frequency_parameters;
Intan.notes = notes;
Intan.aux_input_channels = aux_input_channels;

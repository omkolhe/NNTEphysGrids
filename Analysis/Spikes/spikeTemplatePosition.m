...
function [spikeAmps, spikeDepths, templateDepths, tempAmps, tempsUnW, templateDuration, waveforms, max_site] = spikeTemplatePosition(fpath,ycoords)
...
spikeTemplates = readNPY(fullfile(path, 'spike_templates.npy'));
tempScalingAmps = readNPY(fullfile(path, 'amplitudes.npy'));

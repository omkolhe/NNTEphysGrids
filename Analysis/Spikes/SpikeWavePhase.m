...
for i=1:Spikes.nSpikes % iterrating over all spikes 
    ...
    Spikes.spikeTrigPhaseMapPre(i).allPMs = cat(3,a{1,1:end});
    Spikes.spikeTrigPhaseMapPre(i).rawPhaseMap = circ_mean(Spikes.spikeTrigPhaseMapPre(i).allPMs,[],3);
    Spikes.spikeTrigPhaseMapPre(i).PA = abs(circ_r(angle(Spikes.spikeTrigPhaseMapPre(i).allPMs),[],[],3));
    Spikes.spikeTrigPhaseMapPre(i).meanPA = mean(Spikes.spikeTrigPhaseMapPre(i).PA,'all','omitnan');
    a = 1*exp(1i*Spikes.spikeTrigPhaseMapPre(i).rawPhaseMap);
    Spikes.spikeTrigPhaseMapPre(i).phaseMap = angle(inpaint_nans(a,3));
    [Spikes.spikeTrigPhaseMapPre(i).pm,Spikes.spikeTrigPhaseMapPre(i).pd,Spikes.spikeTrigPhaseMapPre(i).dx,Spikes.spikeTrigPhaseMapPre(i).dy] = getPhaseGradient( Spikes.spikeTrigPhaseMapPre(i).phaseMap, parameters.xspacing,parameters.yspacing);
    Spikes.spikeTrigPhaseMapPre(i).sourcePoint = find_source_points2(1,parameters.X,parameters.Y,Spikes.spikeTrigPhaseMapPre(i).dx,Spikes.spikeTrigPhaseMapPre(i).dy);
    ...
    Spikes.spikeTrigPhaseMapPost(i).allPMs = cat(3,a{1,1:end});
    Spikes.spikeTrigPhaseMapPost(i).rawPhaseMap = circ_mean(Spikes.spikeTrigPhaseMapPost(i).allPMs,[],3);
    Spikes.spikeTrigPhaseMapPost(i).PA = abs(circ_r(angle(Spikes.spikeTrigPhaseMapPost(i).allPMs),[],[],3));
    Spikes.spikeTrigPhaseMapPost(i).meanPA = mean(Spikes.spikeTrigPhaseMapPost(i).PA,'all','omitnan');
    a = 1*exp(1i*Spikes.spikeTrigPhaseMapPost(i).rawPhaseMap);
    Spikes.spikeTrigPhaseMapPost(i).phaseMap = angle(inpaint_nans(a,3));
    [Spikes.spikeTrigPhaseMapPost(i).pm,Spikes.spikeTrigPhaseMapPost(i).pd,Spikes.spikeTrigPhaseMapPost(i).dx,Spikes.spikeTrigPhaseMapPost(i).dy] = getPhaseGradient( Spikes.spikeTrigPhaseMapPost(i).phaseMap, parameters.xspacing,parameters.yspacing);
    Spikes.spikeTrigPhaseMapPost(i).sourcePoint = find_source_points2(1,parameters.X,parameters.Y,Spikes.spikeTrigPhaseMapPost(i).dx,Spikes.spikeTrigPhaseMapPost(i).dy);
